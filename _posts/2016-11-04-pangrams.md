...
However, there's a small hitch. Because Korean characters are all squeezed into super-convenient syllable blocks, they get warped slightly depending on their location. Our letter ㄱ (g) is different when it's in the syllable "길" (*gil*, road), "굴" (*gool*, oyster), and "궐" (*gwol*, palace):
