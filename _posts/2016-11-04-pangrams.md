...
A *virama*, or killer stroke, can eliminate a vowel. For instance, the word for holiday (**छुट्टी**, *chutti*) has a virama under one of the *ta* letters, making is a plain **ट्** (*t*). However, the virama is not always used. For instance, the word for purple (**बैंगनी**, *bainganee*) has a final letter **न** (*na*) that is modified by ी to become **नी** (*nee*). But the word for eggplant (**बैंगन**, *baingan*) should have a virama below the **न** -- it doesn't: the virama is assumed.
